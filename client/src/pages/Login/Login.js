...
//             setError('')
//             setIsSuccess("You are now logged in, you will be redirected to the home page")
//             console.log(userData.data.token)
//             localStorage.setItem('token', JSON.stringify(userData.data.token))
//             localStorage.setItem('email', userData.data.data.user.email)
//             setUser({
//               name: `${userData.data.data.user.name}`,
//               email: `${userData.data.data.user.email}`,
//               photo: `${userData.data.data.user.photo}`,
...
//         //console.log("Something wrong !!!", err.response.data.message)
...
//                 <video className={Styles["bg__video_content"]} autoplay="" muted="" loop="" >
...
//                   {
//                     error? <Alert style={{fontSize: 10 + "px"}} variant={"danger"} role="alert">
//                        { error }
//                     </Alert> : ''
//                  }
//                  {
...
//                         <input onClick={handleSubmit} className={`${Styles["input-btn"]} ${Styles.login}`} type="submit" value="Login" />
//                     </div>
